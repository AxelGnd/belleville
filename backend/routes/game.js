...
// NOUVEAU
const EVENTS = [
{ id: 'COL', type:'crisis', title:'Cold Wave',story:'A severe cold wave sweeps through Belleville, dropping temperatures below freezing. Heating demand skyrockets across the city.', info:"Winters below -10°C can raise a city's heating demand by over 30%.", desc:'All buildings consume +1 Energy this round.', effect:'demand_plus1_all' },
{ id: 'HEA', type:'crisis', title:'Heat Wave',story:'An intense heat wave strikes Belleville. Air conditioning runs at maximum capacity, driving up energy demand.',  info:'Heatwaves above 35°C can push air conditioning demand up by 40%.', desc:'All buildings consume +1 Energy this round.', effect:'demand_plus1_all' },
{ id: 'TOX', type:'crisis', title:'Toxic Leak',story:'An industrial accident releases harmful chemicals into the air and soil. A well-equipped hospital can help contain the crisis.', info:'Industrial leaks can contaminate water supplies for over 100,000 people in days.', desc:'Hospital Lv2: nothing. Hospital Lv1/0: +2 Pollution.', effect:'toxic_leak' },
{ id: 'MAT', type:'crisis', title:'Material Shortage',story:'Global supply chain disruptions cause a shortage of construction materials, raising prices and delaying projects.', info:'Global supply shortages can raise construction material costs by 20-50%.', desc:'All building upgrades cost +1 Credit this round.', effect:'upgrade_cost_plus1' },
{ id: 'OVE', type:'crisis', title:'Overcast Skies & No Wind',story:'Heavy atmospheric stagnation brings thick fog and zero wind, reducing renewable electricity production.', info:'Solar and wind output can drop by up to 80% during still, cloudy weather.', desc:'Green Energy installations produce 0 Energy this round.', effect:'green_zero' },
{ id: 'RES', type:'crisis', title:'Respiratory Crisis',story:'Air pollution reaches unhealthy levels. More residents develop breathing problems, straining healthcare services.', info:'Air pollution causes an estimated 7 million premature deaths worldwide each year.', desc:' Hospital Lv2: nothing. Lv1: -1 cr each. Lv0: -2 cr each.', effect:'respiratory_crisis' },
{ id: 'SEV', type:'crisis', title:'Severe Drought',story:'After months without rain, strict water restrictions make maintaining urban green spaces difficult.',  info:'Droughts can reduce urban green space survival rates by more than 50%.', desc:'Parks lose their effect this round.', effect:'park_zero' },
{ id: 'EUR', type:'opportunity', title:'European Grants',story:'Belleville secures funding from a European development program to invest in cleaner energy and infrastructure.', info:'The EU has invested over 1 trillion euros in green transition funds since 2020.', desc:'Each player gains 2 Credits.', effect:'all_gain2cr' },
{ id: 'TEC', type:'opportunity', title:'Technological Breakthrough',story:'The Research Center announces a major breakthrough in smart materials, reducing costs and resource consumption.', info:'R&D investment cuts renewable technology costs by roughly 10% per year.', desc:'Level 2 upgrades cost 2 fewer Credits this round.', effect:'upgrade_cost_minus2' },
{ id: 'EAR', type:'opportunity', title:'Earth Day',story:'Inspired by Earth Day, citizens volunteer to clean the streets, reducing pollution without using city funds.', info:'Earth Day mobilizes over 1 billion people globally each year for environmental action.', desc:'The next Pollution Cleanup action is free.', effect:'free_depollute' },
{ id: 'NEW', type:'opportunity', title:'New Bike Lanes',story:'Belleville opens a new network of bike lanes, encouraging cycling and reducing traffic pollution.', desc:'Reduce Pollution by 1 immediately.', info:'Cities with more bike lanes see up to 15% lower local air pollution.', desc:'Reduce Pollution by 1 immediately.', effect:'pollution_minus1' },
{ id: 'MUN', type:'neutral', title:'Municipal Elections',story:"Election season sparks intense debates, forcing leaders to cooperate on the city's future.", desc:'If no Grand Project is funded this round: +1 Pollution.', info:'Voter turnout in local elections influences up to 60% of urban policy decisions.', desc:'If no Grand Project is funded this round: +1 Pollution.', effect:'elections' },
{ id: 'ENV', type:'neutral', title:'Environmental Audit',story:"Scientists publish a detailed audit revealing the true climate impact of Belleville's energy mix.",  info:'Environmental audits can cut a city\'s industrial emissions by 10-25%.', desc:'Fossil Lv2: +2 Poll. Fossil Lv1: +1 Poll. Dismantled: -1 Poll.', effect:'audit' },
];
...
router.post('/:game_id/draw-event', async (req, res) => {
  ...
  ? EVENTS.find(e => e.id === String(event_number).trim().toUpperCase())
